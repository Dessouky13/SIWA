...
const socials = [
  { label: 'Instagram', href: 'https://www.instagram.com/siwa_with_kelany?utm_source=qr&igsh=MW1zdDdtNDc0ZW90dQ==' },
  { label: 'Facebook', href: 'https://www.facebook.com/share/1CFfFpV1H9/' },
  { label: 'TikTok', href: 'https://www.tiktok.com/@siwa_with_kelany?_r=1&_t=ZS-95g03jc6f4R' },
  { label: 'Threads', href: 'https://www.threads.com/@siwa_with_kelany?invite=0' },
  { label: 'Tripadvisor', href: 'https://www.tripadvisor.com/Attraction_Review-g303857-d26610134-Reviews-Mohamed_Kelany-Siwa_Matrouh_Governorate.html' },
];
...
export default function FloatingCompass({ open = false, onClose }) {
  ...
  const navLinks = [
    ...
    { label: t('navChronicle'), href: '#chronicle' },
    { label: t('navBook'), href: '#inquiry' },
  ];
          ...
          >
            ...
            <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-20">
              <div className="mb-6 flex items-center justify-between">
                <p className="font-body text-sm uppercase tracking-[0.35em] text-primary-foreground/70">Siwa with Kelany</p>
